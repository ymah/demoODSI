...
echo "Owner" && sleep 1
make -C src/partitions/x86/owner/ clean
echo "sp1" && sleep 1
make -C src/partitions/x86/sp1Task/ clean
echo "sp2" && sleep 1
make -C src/partitions/x86/sp2Task/ clean
echo "sp3" && sleep 1
make -C src/partitions/x86/sp3Task/ clean
echo "Network manager" && sleep 1
make -C src/partitions/x86/NetworkMngr/ clean
...
#make -C src/partitions/x86/pip-freertos/Demo/pip-kernel/ clean clean
